...
- WORK Precision Protocol V2 / AMO Unit Protocol V8 is the confirmed additive
  ...
  path; V8 settlement accepts only confirmed V8 frozen terms. The exact V8
  pins are recorded with `WORK_AMO_V8_WRITES_ENABLED=0` until migration and
  replay complete; Q8/V6 cannot be re-enabled after the boundary. V8 writes
  open only when exact declaration carrier, block/index/output/record/
