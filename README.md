...
- Both the public and Computer-embedded Boost “Post a Boost” and “What’s happening?” buttons open the same composer with Proof and WORK signal choices, including WORK-only, and Files attachments. The separate Computer Mail compose Boost ticker retains its positive Proof self-send requirement and optional WORK attachment. Proof signal is the self-send amount; WORK signal uses a canonical local-wallet WORK transfer in the same transaction.
