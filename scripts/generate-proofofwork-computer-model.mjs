...
const MODEL_SIGNIFICANT_DIGITS = 12;
...
function canonicalNumber(value) {
  if (!Number.isFinite(value)) {
    throw new Error(`Model produced a non-finite number: ${value}`);
  }
  if (value === 0) return 0;
  return Number(value.toPrecision(MODEL_SIGNIFICANT_DIGITS));
}
