...
- Preserve the ID fee split: 1,000 proofs for new registrations, 546 proofs for receiver updates, direct transfers, on-chain listings, delistings, and buyer-funded marketplace transfers.
...
- Keep Computer's IDs workspace isolated from Marketplace. IDs is for registration, receiver updates, and direct transfers; Marketplace is for on-chain listings, purchases, delistings, credit sale-ticket trades, and future asset trades.
