...
refund = return of proofs to a user for a non-canonical or invalid payment
WORK treasury = treasury-controlled address holding WORK credit balance
```
...
WORK balances, wallet proof balances, USD values, and floor values are live chain/API
...
| Address | WORK balance | Confirmed wallet balance proofs | Mempool net proofs | Notes |
| --- | ---: | ---: | ---: | --- |
...
```text
WORK floor: 8.679693276186166 proofs / WORK
Confirmed network value: 182,273,558.79990947 proofs
Treasury WORK mark: 80,972,858.57354075 proofs
WORK mint cost basis at 1 proof / WORK: 9,329,000 proofs
Unrealized WORK gain versus mint: 71,643,858.57354075 proofs
Multiple versus mint: 8.679693276186166x
Return versus mint: 767.9693276186166%
Total confirmed treasury mark: 84,572,960.57354075 proofs
```

## Registry Treasury Sweeps

| Date confirmed | Source | Destination | Input proofs | Output proofs | Fee proofs | Inputs | Block | Txid | Notes |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 2026-05-13 | Canonical mainnet registry `bc1qfwytlzyr3ym3enz2eutwtjsf9kkf6uqkjydk3e` | `bitcoin@proofofwork.me` owner address `1F1p9UEHuH5KTFR7Zsx93Khdrqhj6t5nFv` | 235,098 | 217,021 | 18,077 | 241 | 949274 | [`1f350524080f6f7ea2e8de685d2ea93468cea1987933ff27592499773fe4edc5`](https://mempool.space/tx/1f350524080f6f7ea2e8de685d2ea93468cea1987933ff27592499773fe4edc5) | Consolidated 228 registration UTXOs of 1,000 proofs and 13 mutation UTXOs of 546 proofs. Confirmed at 2026-05-13 23:02:22 UTC. |
