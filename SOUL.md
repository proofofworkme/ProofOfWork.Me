...
- Inception/INCB market update. Report confirmed Inception actions, valid attached WORK, confirmed INCB supply, holders, transfers, sales, current live and frozen INCB floor/network value, and the current sealed INCB sale-ticket book or explicitly say when the book is empty.
