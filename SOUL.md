...
- WORK mint-to-floor update. Report mint price, current confirmed floor proofs per WORK, floor multiple from mint, and confirmed ProofOfWork Computer network value. Formula: `floor_proofs_per_work = floor.networkValueSats / 21000000`; mint multiple is `floor_proofs_per_work / 1`.
