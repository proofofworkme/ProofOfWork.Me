...
[[ $EUID == 0 && $# == 0 ]]
name=proofofwork-www-pre-4515c3bc3421-20260913T070757Z
root=/var/backups/proofofwork-ui/rollback-roots/$name
hold=/var/backups/proofofwork-ui/recovery-evidence/audit17-boost-20260919
archive_name=proofofwork-ui-release-2ddefac163d5-20260905T204437Z.tgz
archive=/var/backups/proofofwork-ui/releases/$archive_name
manifest_sha=a218dd6e4b55a740f12cdb7d63559066f174c5e5e8257645e8a2afb2a90d9816
tree_sha=eef49256e82c4c797faa65d6731153b2aa7c7b8cf03c8764b31b426d07a5b2ce
[[ ! -e $hold && ! -L $hold ]]
