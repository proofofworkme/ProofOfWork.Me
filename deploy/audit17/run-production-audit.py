...
root='/var/tmp/proofofwork-deploy/audit17-tools'
...
assert commit=='07929dd3c6e422fa1955c6cbf07007330eca0519'
...
os.execve('/opt/node-v24.18.0-linux-x64/bin/node',['node','--max-old-space-size=2048',GATES[sys.argv[1]]],env)
