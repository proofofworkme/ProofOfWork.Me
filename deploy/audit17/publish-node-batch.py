...
os.umask(0o077)
RELEASE='005a4e582f58-20260919T165018Z'
COMMIT='005a4e582f5887c51865fbedc757d4597be9df4b'
OLD='6eb4a1e07131fc0b27d381dda52986f9d1bf3398'
TREE='fc17904cf51ba10e04d400aaab896f9e38690a07'
RUNTIME='96f5fe12fc57ea802cb4a638826b7297694ccc7fdb24f470467c922cb771823f'
...
proof=json.loads(pathlib.Path('/home/powadmin/audit17-shadow-core-005a4e5/receipt.json').read_text());assert proof['ok'] is True
...
try:
    ...
    shadow=state('proofofwork-audit17-batch-shadow.service')
    if shadow['LoadState']=='loaded':
        run(['systemctl','stop','proofofwork-audit17-batch-shadow.service'])
    else:
    ...
    request=pathlib.Path('/var/tmp/proofofwork-deploy/proofofwork-node-release-005a4e5-20260919T165018Z.tgz')
