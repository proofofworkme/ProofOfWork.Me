...
MAX_ENV = 4 * 1024 * 1024
PROBE_RELEASE = 'dbfc3f2614a1-20260922T034136Z'
PROBE_COMMIT = 'dbfc3f2614a1a2a215ba56482a416712b1e45faf'
PROBE_TREE = '62d74dc88b194c97c37d8d49287864055caf8a6d'
PROBE_SCRIPT_SHA256 = '469ea54f83d109e56549f97bfe18d0b2ec54afa6ed972ed9c40bce7fc6367e4e'
PROBE_SCRIPT_COPY = '/data/proofofwork-audit5-probe-' + PROBE_RELEASE + '-retry3.mjs'
PROBE_OUTPUT_ROOT = '/data/proofofwork-audit5-probe-' + PROBE_RELEASE + '-retry3'
PROBE_OUTPUT = PROBE_OUTPUT_ROOT + '/attempt'
PROBE_OUTPUT_METADATA = 'probe-output-retry3.json'
