...
MAX_ENV = 4 * 1024 * 1024
PROBE_RELEASE = 'a1e1f9b1c18d-20260922T041933Z'
...
PROBE_SCRIPT_COPY = '/data/proofofwork-audit5-probe-' + PROBE_RELEASE + '-retry6.mjs'
PROBE_OUTPUT_ROOT = '/data/proofofwork-audit5-probe-' + PROBE_RELEASE + '-retry6'
PROBE_OUTPUT = PROBE_OUTPUT_ROOT + '/attempt'
PROBE_OUTPUT_METADATA = 'probe-output-retry6.json'
