...
- Boost writers pay likes, replies, reboosts, follows, and unfollows directly to the current owner/profile recipient; only direct transfers and listing-sale mutations pay the 546-proof Boost registry fee. The feed binds each action to the current confirmed owner, so purchases and transfers route future engagement revenue to the new owner without changing confirmed history. AMO reads active Boost sale tickets from the replayed Boost feed state and displays them with the other asset books.
